...
const Services = () => {
  return (
    <section className="relative bg-gray-50 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 pt-16 md:pt-8 pb-40" id="services">
      <div className="text-center font-bold">
        <h1 className="text-4xl">
          <span className="text-gray-900 tracking-wide title">Our Marketing Approach</span>
        </h1>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row mt-16 text-center md:-mx-4 flex-wrap gap-8">
        ...
        <Tilt>
          <div className="w-72 flex flex-col items-center bg-white rounded-lg shadow-md p-8 md:mx-4 cursor-pointer">
            <div className="w-12 h-12 flex justify-center items-center p-3 mb-2 rounded-full bg-green-100">
              <svg className="fill-current text-green-500" width="24" height="22" viewBox="0 0 24 22" fill="none"
            ...
            <h4 className="text-xl font-bold">Effective Website</h4>
            <p className="mt-1"> Get website created like no one else . Get a website that actually work!.</p>
        ...
        <Tilt >
          <div className="w-72 flex flex-col items-center bg-white rounded-lg shadow-md p-8 md:mx-4 cursor-pointer ">
            <div className="w-12 h-12 flex justify-center items-center p-3 mb-2 rounded-full bg-green-100">
              <svg className="fill-current text-green-500" width="25" height="32" viewBox="0 0 25 32" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <h4 className="text-xl font-bold">Logo and Illustrations </h4>
            <p className="mt-1"> Give your clinic a professional indetity by creating a professional logo and graphic illustrations where needed . </p>
      ...
      <div className="flex flex-col items-center justify-center md:flex-row mt-16 text-center md:-mx-4 flex-wrap gap-8">
        <Tilt>
          <div className="w-72 flex flex-col items-center rounded-lg shadow-md p-8 md:mx-4 bg-white cursor-pointer">
            <div className="w-12 h-12 flex justify-center items-center p-3 mb-2 rounded-full bg-green-100">
              <svg className="fill-current text-green-500" width="24" height="24" viewBox="0 0 24 24" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <h4 className="text-xl font-bold">Google Ads</h4>
            <p className="mt-1">

            {/* We have managed over $1,300,000 in AdWords campaigns to get results */}
                Get your website ranked top on google with the power of Google Ad Campaigns
            </p>
        ...
        <Tilt>
          ...
          <div className="w-72 flex flex-col items-center bg-white rounded-lg shadow-md p-8 md:mx-4 cursor-pointer">
            <div className="w-12 h-12 flex justify-center items-center p-3 mb-2 rounded-full bg-green-100">
              <svg className="fill-current text-green-500" width="32" height="19" viewBox="0 0 32 19" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <h4 className="text-xl font-bold">Social Media (Free)
            </h4>
            <p className="mt-1">Professinal and engaging content postest regularly on your business social media accounts.</p>
